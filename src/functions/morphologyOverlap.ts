...
export async function morphologyOverlap(
  sketch: Sketch<Polygon> | SketchCollection<Polygon>
): Promise<ReportResult> {
  const box = sketch.bbox || bbox(sketch);
  const metricGroup = project.getMetricGroup("morphologyOverlap");
...
export default new GeoprocessingHandler(morphologyOverlap, {
  title: "morphologyOverlap",
