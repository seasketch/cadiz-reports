...
export async function communitiesOverlap(
  sketch: Sketch<Polygon> | SketchCollection<Polygon>
): Promise<ReportResult> {
  const box = sketch.bbox || bbox(sketch);
  const metricGroup = project.getMetricGroup("communitiesOverlap");
...
export default new GeoprocessingHandler(communitiesOverlap, {
  title: "communitiesOverlap",
